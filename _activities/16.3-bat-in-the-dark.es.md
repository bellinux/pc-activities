...
content_sections:
  ...
  - title: "Composición del Código"
    ...
    icon: "code"
    content: |
      Dentro del `bucle principal`, usamos el bloque `si... sino...`. La clave es la condición: comprueba si `intensidad de la luz < 30`. Si es verdad (oscuridad), el murciélago vuela. Si es falso (hay luz), el murciélago descansa. Dentro de la rama verdadera hay **cuatro dibujos** que se alternan, cada uno seguido de un `retraso de 200 ms`: eso produce el aleteo. La última pausa también hace falta — sin ella, el cuarto dibujo se borraría de inmediato al reiniciar el bucle: cada imagen necesita su tiempo en pantalla.
