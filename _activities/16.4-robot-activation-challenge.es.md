...
content_sections:
  ...
  - title: "Eventos que Modifican la Memoria"
    type: "learn"
    content: |
      Ahora podemos combinar estas dos ideas. Usaremos un **evento** (tocar un botón) no solo para disparar una animación, sino para **modificar el contenido de nuestra variable**.
