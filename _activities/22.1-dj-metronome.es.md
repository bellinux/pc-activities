...
content_sections:
  ...
  - id: "create"
    ...
    steps:
      - "Necesitaremos 3 componentes: <comp>Inclinación</comp> para controlar los BPM, <comp>BateríaMusical</comp> para el sonido del pulso, y <comp>DibujarEscribir</comp> para mostrar los BPM actuales en la pantalla."
  ...
  - title: "Composición del Código"
    ...
    media: "[700]https://app.protobject.com/generate?metronomo-con-inclinacion&es&dynamic&-1"
