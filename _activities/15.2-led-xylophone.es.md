...
image: src/15.2-led-xylophone/15.2-el-xilofono-del-futuro.svg

video: src/videos/15.2_led_xylophone.mp4
...
content_sections:
  ...
  - id: "learn"
    ...
    media: "src/15.2-led-xylophone/feedback-visual.svg"
  ...
  - title: "Conexión a Múltiples Salidas"
    ...
    media: "src/15.2-led-xylophone/mapeo-multiple.svg"
  ...
  - title: "Adaptando los Datos: La División Mágica"
    ...
    media: "src/15.2-led-xylophone/rango-inclinacion.svg"
  ...
  - id: "reflect"
    ...
    right_content:
      ...
      - media: "src/14-colors-on-the-screen/14.colores-pantalla2.svg"
        # Designer comment: Una imagen de un xilófono con más de un led en el eje x..
        # Comentario Alan: Asigné cada una de las imágenes según su descripción, pero la imagen 3.svg no fue asignada dado que ya coloqué la imagen 2 en la sección de mapeo a múltiples salidas, además de esto, en la imagen final del right context no hay ninguna correspondiente a un xilófono con más de un led en el eje x.
---