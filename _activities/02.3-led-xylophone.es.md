...
content_sections:
  ...
  - title: "Composición del Código"
    ...
    icon: "code"
    content: |
      Haz clic en el signo de interrogación para abrir los comentarios. La clave de este código es que la inclinación se lee dos veces, y las dos fórmulas tienen la **misma forma**: un valor de reposo más la desviación. Para el sonido, `262 + inclinación`, en hercios. Para la luz, `4 + inclinación ÷ 15`. Un mismo dato, dos escalas, la misma idea — ¡por eso luz y sonido nunca se desincronizan!
