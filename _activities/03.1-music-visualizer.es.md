...
content_sections:
  ...
  - title: "Controlando la posición de la luz con Datos"
    type: "learn"
    content: |
      La pantalla es una cuadrícula de LEDs y cada posición se identifica con una coordenada de fila (Y). Para nuestro visualizador, tomaremos el número que nos da el sensor de **nivel de ruido** y lo usaremos para decidir **en qué fila** se encienden los LEDs. Como ese número puede ser muy grande, lo dividimos para ajustarlo al alto de la pantalla, además de esto, este número es restado a 7 para mostrarlo en la posición correcta.
